...
const Navbar = ({isDarkMode,setIsDarkMode}) => {
  ...
  return (
    ...
    dark:hidden className="bg-white dark:bg-black text-black dark:text-white p-4"'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
        ...
        <div className='flex items-center gap-4'>
            ...
            '>Contact <Image src={isDarkMode? assets.arrow_icon_dark : assets.arrow_icon} alt='' className='w-6'/></a>
