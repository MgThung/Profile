...
const Navbar = ({isDarkMode,setIsDarkMode}) => {
  ...
  return (
    <>
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden className="bg-white dark:bg-black text-black dark:text-white p-4"'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
        ...
        <div className='flex items-center gap-4'>
            ...
            <a href="#contact" className='hidden lg:flex item-center gap-3 px-10 
            py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo
            '>Contact <Image src={assets.arrow_icon} alt='' className='w-6'/></a>
