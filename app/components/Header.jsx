      ...
      >
        <Image src={assets.profile_img} alt="" className="rounded-full w-32"/>
         ...
         className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Thung Htike Htoo <Image src={assets.hand_icon} alt="" className='w-6' />
        </motion.h3>
        <motion.h1
         ...
         className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
            frontend web developer based in UAE(Sharjah).
        </motion.h1>
        <motion.p
          initial={{opacity:0}}
        ...
        >
            I am a frontend developer from Yangon, Myanmar with more than 2 years of experience in two companies like ITVisionHub and Anbuchi Technology. 
        </motion.p>
