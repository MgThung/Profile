...
const About = () => {
  return (
    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
       ...
       className='text-center mb-2 text-lg font-Ovo'>Introdution</motion.h4>
       <motion.h2 
        initial={{y:-20,opacity:0}}
          whileInView={{y:0,opacity:1}}
       ...
       className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='w-64 sm:w-80 rounded-3xl max-w-none'>
                <Image src={assets.profile_img} alt='Thung Htike Htoo' className='w-full rounded-3xl' />
            </motion.div>
            <motion.div
            initial={{opacity:0}}
          whileInView={{opacity:1}}
          transition={{duration:0.6,delay:0.8}}
            className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'> 
                    I am an experienced Fronted Developer with over 3 years
              ...
              className='flex items-center gap-3 sm:gap-5'>
                    {toolsData.map((tool,index) => (
                        ...
                        key={index} className='flex items-center justify-center w-12 sm:w14 aspect-square border 
